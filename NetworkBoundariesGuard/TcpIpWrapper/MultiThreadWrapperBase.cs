...
namespace NTcpIpWrapper
{
    internal abstract class MultiThreadWrapperBase
    {
        ...
        protected MultiThreadWrapperBase(SNfoConnexion nfo)
        {
            _nfo = nfo;
        }

        ~MultiThreadWrapperBase()
        {
            if (false == _isClosing)
            {
                Close();
        ...
        public void Close()
        {
            Console.WriteLine("*** Début de l'appel de MultiThreadWrapperBase.Close()");
            _isClosing = true;
            Thread.Sleep(250);
            Console.WriteLine("*** Fin de l'appel de MultiThreadWrapperBase.Close()");
        }
        ...
        public ELogSendReceivedMsgStatut ModeOfLogForSentMsg
        {
            get
            {
                return _manager.ModeOfLogForSentMsg;
            }
            set
            {
                _manager.ModeOfLogForSentMsg = value;
            }
        }
        ...
        public ELogSendReceivedMsgStatut ModeOfLogForReceivedMsg
        {
            get
            {
                return _manager.ModeOfLogForReceivedMsg;
            }
            set
            {
                _manager.ModeOfLogForReceivedMsg = value;
            }
        }
